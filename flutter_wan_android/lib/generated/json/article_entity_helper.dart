...
articleDataFromJson(ArticleData data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = new List<ArticleTag>();
		(json['tags'] as List<dynamic>).forEach((element) {
			data.tags.add(articleTagEntityFromJson(ArticleTag(), json));
		});
	}
	if (json['title'] != null) {
...
Map<String, dynamic> articleDataToJson(ArticleData entity) {
	...
	if (entity.tags != null) {
		data['tags'] =  entity.tags.map((e) => e.toJson()).toList();
	}
...
articleTagEntityFromJson(ArticleTag data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> articleTagEntityToJson(ArticleTag entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
